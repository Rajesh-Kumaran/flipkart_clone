                ...
                <div className="description">
                    ...
                    <div className="highlights">
                        ...
                        <ul className="highlight">
                            <li className="hightlight-item">{data.Descripition}</li>
                            <li className="hightlight-item">{data.Display}</li>
                            <li className="hightlight-item">{data.Camera}</li>
                            <li className="hightlight-item">{data.Battery}</li>
                            <li className="hightlight-item">{data.Proccessor}</li>
                        </ul>
                    </div>
                </div>

                <div className="RatingsAndReviews">
                    <p className="RatingsAndReview-title">
                        Ratings & Reviews
                    </p>
